...
export function is_boolean(rule_name) {
...
export function create_string_or_regexp_validator(rule_name, allow_empty_string = true) {
    return function (option) {
...
export function create_list_value_validator(rule_name, values, allow_reg = true) {
...
export function create_number_validator(rule_name, allow_neg = true) {
    return function (option) {
