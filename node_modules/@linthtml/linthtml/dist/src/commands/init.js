...
const GENERATORS = {
    TS: {
        name: ".linthtmlrc.ts",
        generate_content: (content, isLegacyConfig = false) => {
            const type_import = isLegacyConfig ? "LegacyConfig" : "Config";
            return `import type { ${type_import} } from '@linthtml/linthtml';\n\nexport default ${JSON.stringify(content, null, "\t")} satisfies ${type_import};`;
        }
    },
    CJS: {
        name: ".linthtmlrc.cjs",
...
export default async function init_command() {
