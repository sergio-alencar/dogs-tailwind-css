...
export default async function print_config(path) {
    if (path === "") {
        process.stderr.write(chalkTemplateStderr `A file path must be provided when using the {blue.bold print-config} option.`);
