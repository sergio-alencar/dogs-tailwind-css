...
const { isRegExp } = node_util.types;
/**
...
function is_tag_node(node) {
    return [domelementtype.ElementType.Tag, domelementtype.ElementType.Style, domelementtype.ElementType.Script].indexOf(node.type) !== -1;
}
...
function is_text_node(node) {
    ...
    return node.type === domelementtype.ElementType.Text;
}
/**
...
function is_comment_node(node) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-enum-comparison
    return node.type === domelementtype.ElementType.Comment;
}
function is_directive_node(node) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-enum-comparison
    return node.type === domelementtype.ElementType.Directive;
}
...
function node_tag_name(node) {
    switch (node.type) {
        // eslint-disable-next-line @typescript-eslint/no-unsafe-enum-comparison
        case domelementtype.ElementType.Text:
            return "Text Node"; // get text node content but truncate ?
        // eslint-disable-next-line @typescript-eslint/no-unsafe-enum-comparison
        case domelementtype.ElementType.Comment:
            return "Comment";
        default:
...
function has_parent_node(node) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-enum-comparison
    return !!node.parent && node.parent.type !== domelementtype.ElementType.Root;
}
