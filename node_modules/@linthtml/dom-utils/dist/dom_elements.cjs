 ...
 */
class Node extends ExtendedNode(domhandler.NodeWithChildren) {
    constructor() {
        super(...arguments);
        this.parent = null;
...
class Element extends Node {
    constructor(name, attributes, children = [], type = name === "script"
        ? domelementtype.ElementType.Script
        : name === "style"
            ? domelementtype.ElementType.Style
            : domelementtype.ElementType.Tag) {
        super(type, children);
        this.name = name;
...
class Document extends Node {
    constructor(children) {
        super(domelementtype.ElementType.Root, children);
    }
}
